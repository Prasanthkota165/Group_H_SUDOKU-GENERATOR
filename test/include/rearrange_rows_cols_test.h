 ...
 * 
 * @param[in] sudoku[][9], input parameter to the function rearrange_rows_cols function.
 *  
 ...
 * 
 * @param[in] rearranged_sudoku [][9], output parameter to the function rearrange_rows_cols function.
 * 
 * @return FALSE if the test says within the boundaries. True if the test failed.
 *  
 */
 ...
 * @param[in] sudoku[][9], input parameter to the function rearrange_rows_cols function.
 * 
 * @return FALSE if the test says values are within the range [1,9]. True if the test failed.
 *  
 */
...
/**
 * Testing function to check the identical behaviour of the rearrange_rows_cols_function.
 * 
 * @param[in] sudoku[][9], input parameter to the function rearrange_rows_cols function.
 * 
 * @param[in] rearranged_sudoku [][9], output parameter to the function rearrange_rows_cols function.
