 ...
 * 
 * @param[in] sudoku[9][9], input parameter to the function rearrange_rows_cols function.
 *
 * @param[in] rearranged_sudoku[9][9], output parameter to the function rearrange_rows_cols function.
 *  
