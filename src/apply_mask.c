...
*/
void apply_mask(int rearranged_sudoku [9][9], int diff_level, int masked_sudoku [9][9]){
    int total_num_cells = 81;                                       /* total_num_cells ... number of cells in the Sudoku game */
    int l = 0, m = 0, random_cell;                                  /* l and m ... index location of cells to be masked, random_cell ... random number between 1 to 81 to be used for masking*/
    ...
    /* track_duplicate_random_num ... track no duplicate data is generated by random number generator*/
    int track_duplicate_random_num[cells_tobe_masked];
