...
{
     int total_num_cells = 81;                       /* The total number of cells in the Sudoku game */
     int max_track_dupplicate_size = 57;             /* The maximum number of cells that will be masked */           
     ...
     {        
        case 0:  
            cells_tobe_masked = 41;    /* 41 locations will be masked and dificulty level 0 */                              
            break;

        case 1:
            cells_tobe_masked = 47;    /* 47 locations will be masked and dificulty level 1 */
            break;

        case 2:
            cells_tobe_masked = 53;    /* 53 locations will be masked and dificulty level 2*/
            break;

        case 3:
            cells_tobe_masked = 57;    /* 57 locations will be masked and dificulty level 3*/
            break;
    ...
    for(int k = 0; k < cells_tobe_masked; k++)
    {
        ...
        *(track_duplicate_random_num + k) = random_cell;
        ...
        /* The following code checks if duplicate random numbers are generated, if yes re-enforces 
