...
void apply_mask(int rearranged_sudoku [ROWS][COLS], int diff_level, int masked_sudoku [ROWS][COLS])
{
     ...
     int l = 0, m = 0, random_cell;                                  /* l and m ... index location of cells to be masked, random_cell holds random number between 1 to 81*/
     ...
     int *track_duplicate_random_num;
     ...
     {        
        case 0:  
            ...
            track_duplicate_random_num = (int*)calloc(41, sizeof(int));    /* To track no duplicate data is generated by random number generator*/
            break;

        case 1:
            cells_tobe_masked = 47;    /*47 locations will be masked*/

            track_duplicate_random_num = (int*)calloc(47, sizeof(int));
            break;

        case 2:
            cells_tobe_masked = 53;    /*53 locations will be masked*/

            track_duplicate_random_num = (int*)calloc(53, sizeof(int));
            break;

        case 3:
            cells_tobe_masked = 57;    /*57 locations will be masked*/

            track_duplicate_random_num = (int*)calloc(57, sizeof(int));
            break;
