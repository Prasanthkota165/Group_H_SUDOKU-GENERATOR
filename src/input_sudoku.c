 ...
 * @file input_sudoku.c
 *
 * Purpose  : This function askes the user for the difficulty level and number 
 *             of sudokus that the user wants to generate.
 *
 * Language : C
 *
...
static inline void clear_input_buffer(){
    char c = 0; 
    while ((c = getchar()) != '\n' && c != EOF); /*Loop over input buffer and 
                                                    consume chars until buffer 
                                                    is empty*/
}
/**
...
void input_sudoku(int *diff_level,int *no_sudoku){ 
	...
	scanf("%f",&a);
        x=a;
        /* Checks whether the difficulty level is in the specified range*/
        if(x<=3&&x>=0&&x==a) {
            *diff_level=x;
            printf("......................................................\n");
            break;
    ...
    if (i==0) { /* If the user exceeds the inputs limit, this loop will execute 
                to terminate the program*/
        printf("\n............YOU HAVE REACHED MAXIMUM ATTEMPTS..........\n");               
        exit(0);
    }
    while(j!=0) {/*Asks the user for number of sudokus.*/
        printf("Enter the number of sudokus you would like to print between 1 "
                    "to 40:\n->");
        scanf("%f",&b);
        y=b;
    ...
    if (j==0) {/* If the user exceeds the inputs limit, this loop will execute 
                to terminate the program*/
        printf("\n................YOU HAVE REACHED MAXIMUM ATTEMPTS........\n");
        exit(0);
    }
